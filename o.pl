#!/usr/bin/env perl
# Este arquivo era originalmente nomeado como 'openkore.pl', porém foi renomeado para 'o.pl'
# seguindo as instruções para resolver o erro "Illegal Program / Programa Ilegal"
#########################################################################
